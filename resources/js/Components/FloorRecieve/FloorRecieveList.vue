                ...
                >
                    <template #item-action="{ id }">
                        ...
                        <div class="flex flex-wrap gap-1 justify-center pt-1 pb-1">
                            <Link :href="`/edit-floor-recieve-page?id=${id}`" class="bg-blue-500 hover:bg-blue-700 text-white py-1 px-2 square text-xs">
                                <i class="bi bi-pencil"></i>
                            </Link>
                            <button
                                @click="approvedRequest(id)"
                                class="bg-green-500 hover:bg-green-700 text-white py-1 px-2 square text-xs">Approve
                            </button>
                            <button
                                @click="cancelRequest(id)"
                                class="bg-red-500 hover:bg-red-700 text-white py-1 px-2 square text-xs"><i class="bi bi-x"></i>
                            </button>
