...
<div class="  flex items-center justify-center p-4">
  <div class="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
    ...
    <div class="mb-4 text-center">
      <p><span style="color: blueviolet;">Product Name:</span> {{ page.props.floorRecieve.product.name }}</p>
      <p><span style="color: blueviolet;">Available Stock:</span> {{ page.props.floorRecieve.product.unit }}</p>
    </div>
