    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="p-6 max-w-2xl">
            ...
            <form class="space-y-5">
                ...
                <input type="text" v-model="form.product_id" hidden />
                ...
                <div>
                    ...
                    <input
                        ...
                        class="w-full px-4 py-2 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400"
                    />
                    <p v-if="errors.reqisition_no" class="text-red-500">
                        {{ errors.reqisition_no[0] }}
                    </p>
                </div>
        ...
        <div class="mt-10">
            ...
            <div class="relative">
                ...
                <div
                    v-if="isLoading"
                    class="absolute inset-0 bg-white/70 z-10 flex items-center justify-center rounded"
                >
                    <svg
                ...
                >
                    <template #item-action="{ name, id }">
                        <button
                            ...
                            class="bg-green-500 text-white font-bold py-2 px-4 rounded ml-1"
                        >
                            Select
                        </button>
                    </template>
